LES_QUESTIONS = [
  {
    "id": 1,
    "question": "Que jette-t-on sur le ring en cas d'abandon durant un match de boxe ?",
    "propositions": [
      "Culotte",
      "Gant",
      "Éponge",
  ...
  },
  {
    ...
    "reponse": "Georges Marchais",
    "anecdote": "Lénine est à l'origine de la Tchéka, police politique chargée d'éliminer tous les ennemis du nouveau régime qu'il mettait en place."
  },
  {
    "id": 19,
